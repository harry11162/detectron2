...
class CondConvBottleneckBlock(CNNBlockBase):
    ...
    def __init__(
        ...
        *,
        ...
        self.original_route_func = route_func(in_channels, cond_conv_num_experts)

        self.meta_route_func = nn.Sequential(
...
def build_combine_meta_cond_conv_resnet_backbone(cfg, input_shape):
    """
