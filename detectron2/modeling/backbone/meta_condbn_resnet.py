...
class CondBNBasicBlock(CNNBlockBase):
    ...
    def __init__(self, in_channels, out_channels, *, stride=1, norm="BN", meta_channels=None):
        """
        Args:
            in_channels (int): Number of input channels.
            out_channels (int): Number of output channels.
        ...
        self.cond_gamma1 = MLP(3, meta_channels, 64, out_channels)
        self.cond_beta1 = MLP(3, meta_channels, 64, out_channels)
        self.cond_gamma2 = MLP(3, meta_channels, 64, out_channels)
        self.cond_beta2 = MLP(3, meta_channels, 64, out_channels)
