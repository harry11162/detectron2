...
class MyNetwork(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # VFS
        self.pred_meta_head = nn.Sequential(
            nn.Linear(256, 256),
            nn.ReLU(),
            nn.Linear(256, 256),
            nn.ReLU(),
        ...
        self.pred_meta_weight = cfg.MODEL.PRED_META.LOSS_WEIGHT
    ...
    def forward(self, batched_inputs: Tuple[Dict[str, torch.Tensor]]):
        ...
        # PRED_META
        final_feature = F.adaptive_avg_pool2d(features["res4"], (1,1)).flatten(1)
        meta_pred = self.pred_meta_head(final_feature)
        pred_meta_loss = {"pred_meta_loss": F.smooth_l1_loss(meta_pred, metas / 45) * self.pred_meta_weight}
